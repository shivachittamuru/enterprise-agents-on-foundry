"""Typed configuration for the v0.1 Azure foundation.
...
class DatasetVariant(StrEnum):
    ...
    Full AdventureWorks OLTP is explicitly out of scope for v0.1, so the
    enumeration has exactly one member. Keeping it an enumeration rather than a
    bare string makes the eventual second dataset an additive change.
    """
...
class Settings(BaseSettings):
    """Validated view of the environment for setup and validation tasks."""
